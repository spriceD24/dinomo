	...
	class HTMLUtil
	{
		function getOptionsTable($options)
		{
			...
			while($option = $options->iterate()) {
				...
				else if(!is_null($option->formType) && $option->formType == 'LABEL')
				{
					$html = $html.'</table>';
					$html = $html.'<br/><br/>';
					$html = $html.'<table>';
					$html = $html.'<tr><td style="border:1px dashed black;font-weight:bold;font-style:italic"><span style="padding-left:15px">'.$option->optionFormID.'</span></td><td style="border:1px dashed black;font-weight:bold;font-style:italic"><span style="padding-left:15px">&nbsp;'.$option->optionValue.'</span></td></tr>';
				}
				...
				{
					$html = $html.'<tr><td colspan="2" style="border:1px dashed black;"><span style="padding-left:15px">'.$option->optionValue.'</span></td></tr>';
				}else{
					$html = $html.'<tr><td style="border:1px dashed black;"><span style="padding-left:15px">'.$option->optionFormID.'</span></td><td style="border:1px dashed black;"><span style="padding-left:15px">&nbsp;'.$option->optionValue.'</span></td></tr>';
				}
			}
			$html = $html."</table>";
			return $html;			
		...
		function generateUploadEmail($webUrl,$pdfUrl,$project,$currentCategory,$uploadedUser,$forUser)
		{
			...
			$html = $html."<tr>";
			$html = $html."<td>";
			$html = $html."<b>Report for</b>";
			$html = $html."</td>";
			$html = $html."<td>";
			$html = $html.$project->projectName." - ".$currentCategory->categoryName;
			$html = $html."</td>";
			$html = $html."</tr>";
			$html = $html."<tr>";
			$html = $html."<td>";
			...
			$html = $html."</td>";
			$html = $html."<td>";
			$html = $html.$dateUtil->getCurrentDateTimeString();
			$html = $html."</td>";
			$html = $html."</tr>";
			$html = $html."</table>";
			$html = $html."<table>";
			...
			$html = $html."</td>";
			$html = $html."<td>";
			$html = $html."Click <a href='".$pdfUrl."'>here</a> to preview";
			$html = $html."</td>";
			$html = $html."</tr>";
