...
class ProjectDAO {
	...
	function getCategoryOptionsFIXED($projectID, $categoryID) {
		...
		if ($categoryID == 1) {
			...
			$categoryOptions->add ( new CategoryOption ( 1, 1, 7, 7, 'Scaffold and perimeter safety screens in place with no gaps', 'RADIO', true,  array("radioOptions"=>"Yes,No","cannotProceedOn"=>"No") ) );
		...
		if ($categoryID == 2) {
			...
			$categoryOptions->add ( new CategoryOption ( 1, 2, 32, 3, 'Length Correct','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 2, 33, 4, 'Width Correct','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 2, 34, 5, 'Fillets Correct Position','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			...
			$categoryOptions->add ( new CategoryOption ( 1, 2, 37, 8, 'Height Nails','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 2, 38, 9, 'Penetrations for services','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 2, 39, 10, 'Is the Box Square','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 2, 40, 11, 'Working Platform Installed and Safe','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 2, 41, 12, 'Manholes Are Covered','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 2, 42, 13, 'Props in Place','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 2, 43, 14, 'Z Bars','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 2, 44, 15, 'Access Ladders Installed and Secured','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			...
			$categoryOptions->add ( new CategoryOption ( 1, 2, 48, 19, 'Pockets in Correct Position','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
		...
		if ($categoryID == 3) {
			...
			$categoryOptions->add ( new CategoryOption ( 1, 3, 71, 11, 'Wet area and balcony stepdowns in correct position and are they correct','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 3, 7221, 12123, 'Is RL of the Deck correct','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 3, 7215, 124, 'Is Edgeboard in correct position','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 3, 73, 13, 'Overflow blockouts installed in correct position','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 3, 74, 14, 'Are all Penetrations installed','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			...
			$categoryOptions->add ( new CategoryOption ( 1, 3, 77, 17, 'Are correct Sheer Keys installed','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 3, 78, 18, 'Any excess plywood or timber removed','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 3, 79, 19, 'Drip groove installed on balconies','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
		...
		if ($categoryID == 4) {
			...
			$categoryOptions->add ( new CategoryOption ( 1, 4, 104, 4, 'Stairmaster correct position','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 4, 10511, 511, 'Is the bottom and top riser in correct position','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 4, 105171, 5711, 'According to the stairmaster label, is each stairmaster in correct position','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 4, 105, 5, 'Edge boards braced','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 4, 106, 6, 'Centre of Stairmaster flights installed','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
		...
		if ($categoryID == 5) {
			...
			$categoryOptions->add ( new CategoryOption ( 1, 5, 122, 3, 'Length Correct','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 5, 123, 4, 'Width Correct','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 5, 124, 5, 'Fillets Correct Position','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 5, 125, 6, 'Spacers','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 5, 126, 7, 'Height Nails sprayed','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			...
			$categoryOptions->add ( new CategoryOption ( 1, 5, 135, 16, 'Working platform built correctly/safely','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
			$categoryOptions->add ( new CategoryOption ( 1, 5, 136, 17, 'Secured top/bottom of Access Ladder','RADIO', true,  array("radioOptions"=>"Yes,No,N/A") ) );
