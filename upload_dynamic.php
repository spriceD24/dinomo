...
<body>
	...
	<div ng-app="myApp" ng-controller="myCtrl">
		...
		<div class="basic-grey"
			style="background: white; padding: 0px; border: 0px">
	...
	<span class="button-not-selected" id="vertical-span" name="vertical-span"><a href="#" onclick="switchForms('vertical','slab')" id="vertical-link" style="color:#888;text-decoration: none;">&nbsp;Verticals&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></span> -->
		...
		<form action="uploadform.php" id="uploadform" method="post"
			class="basic-grey" enctype="multipart/form-data">
			<div id="slab-form">
				<h1>
				...
				<table style="border: 0px">
					<tr>
						...
						<td><label><input id="projectName" type="text" name="projectName"
								placeholder="Project Name" style="width: 250px" /></label></td>
					</tr>
					<tr>
						<td><label><span>Pour No:</span></label></td>
						<td><label><input id="pourNumber" type="text" name="pourNumber"
					...
					<tr>
						...
						<td><label><input id="temperature" type="text" name="temperature"
								style="width: 100px" /></label></td>
					</tr>
					<tr>
						<td><label><span>Start Of Pour:</span></label></td>
						<td><label> <select name="startOfConcretePour"
					...
					<tr>
						...
						<td><label> <select name="finishOfConcretePour"
								style="width: 100px; height: 25px">
									<option value=''></option>
									<option value='05:00'>05:00</option>
									<option value='05:15'>05:15</option>
					...
					<tr>
						...
						<td><input type="file" name="reportFile"
							placeholder="Select Report" style="width: 250px" /></td>
					</tr>
					<tr>
						<td><label><span style="margin-top: 15px">Photos Required:</span></label></td>
						<td><input type="checkbox" name="photosRequired"
							id="photosRequired" value="Yes" onchange="displayPhotos()"></td>
					</tr>
						...
						<td>
							<table>
								...
								<tr id="photoRow5" style="display: none">
									<td>5.</td>
									<td><input type="file" name="photo5" id="photo5"
										style="width: 250px" /></td>
								</tr>
								<tr id="photoRow6" style="display: none">
									<td>6.</td>
									<td><input type="file" name="photo6" id="photo6"
										style="width: 250px" /></td>
								</tr>
								<tr id="photoRow7" style="display: none">
									<td>7.</td>
									<td><input type="file" name="photo7" id="photo7"
										style="width: 250px" /></td>
								</tr>
								<tr id="photoRow8" style="display: none">
									<td>8.</td>
									<td><input type="file" name="photo8" id="photo8"
										style="width: 250px" /></td>
								</tr>
								<tr id="photoRow9" style="display: none">
									<td>9.</td>
									<td><input type="file" name="photo9" id="photo9"
										style="width: 250px" /></td>
								</tr>
								<tr id="photoRow10" style="display: none">
									<td>10.</td>
									<td><input type="file" name="photo10" id="photo10"
										style="width: 250px" /></td>
								</tr>
								<tr id="photoRow11" style="display: none">
									<td>11.</td>
									<td><input type="file" name="photo11" id="photo11"
										style="width: 250px" /></td>
								</tr>
								<tr id="photoRow12" style="display: none">
									<td>12.</td>
									<td><input type="file" name="photo12" id="photo12"
										style="width: 250px" /></td>
								</tr>
								<tr>
									<td></td>
									<td style="font-size: 11px">
										<button type="button" onclick="addMorePhotos()">+ Add More
											Photos</button>
									</td>
								</tr>
							</table>
				...
				<table style="border: 0px">
					<tr>
						<td><label><span style='margin-top: 15px'>Hob for post fix
									spandrals and cast ins:</span></label></td>
						<td><input type='checkbox' name='Hobforpostfixspandralsandcastins'
							id='Hobforpostfixspandralsandcastins' value='Yes'></td>
					</tr>
					<tr>
						<td><label><span style='margin-top: 15px'>Construction joints /
									dowels:</span></label></td>
						<td><input type='checkbox' name='Constructionjoints/dowels'
							id='Constructionjoints/dowels' value='Yes'></td>
					</tr>
					<tr>
						<td><label><span style='margin-top: 15px'>Wet area and balcony
									stepdowns:</span></label></td>
						<td><input type='checkbox' name='Wetareaandbalconystepdowns'
							id='Wetareaandbalconystepdowns' value='Yes'></td>
					</tr>
					<tr>
						<td><label><span style='margin-top: 15px'>RL Deck / Edgeboard:</span></label></td>
						<td><input type='checkbox' name='RLDeck/Edgeboard'
							id='RLDeck/Edgeboard' value='Yes'></td>
					</tr>
					<tr>
						<td><label><span style='margin-top: 15px'>Overflow blockouts:</span></label></td>
						<td><input type='checkbox' name='Overflowblockouts'
							id='Overflowblockouts' value='Yes'></td>
					</tr>
					<tr>
						<td><label><span style='margin-top: 15px'>Penetrations for
									services:</span></label></td>
						<td><input type='checkbox' name='Penetrationsforservices'
							id='Penetrationsforservices' value='Yes'></td>
					</tr>
					<tr>
						<td><label><span style='margin-top: 15px'>Bond breaker applied:</span></label></td>
						<td><input type='checkbox' name='Bondbreakerapplied'
							id='Bondbreakerapplied' value='Yes'></td>
					</tr>
					<tr>
						<td><label><span style='margin-top: 15px'>Ableflex fixed:</span></label></td>
						<td><input type='checkbox' name='Ableflexfixed' id='Ableflexfixed'
							value='Yes'></td>
					</tr>
					<tr>
						<td><label><span style='margin-top: 15px'>Sheer Keys:</span></label></td>
						<td><input type='checkbox' name='SheerKeys' id='SheerKeys'
							value='Yes'></td>
					</tr>
					<tr>
						<td><label><span style='margin-top: 15px'>Pegs Removed:</span></label></td>
						<td><input type='checkbox' name='PegsRemoved' id='PegsRemoved'
							value='Yes'></td>
					</tr>
					<tr>
						<td><label><span style='margin-top: 15px'>Drip groove:</span></label></td>
						<td><input type='checkbox' name='Dripgroove' id='Dripgroove'
							value='Yes'></td>
					</tr>
					<tr>
						<td><label><span style='margin-top: 15px'>Precast fillet:</span></label></td>
						<td><input type='checkbox' name='Precastfillet' id='Precastfillet'
							value='Yes'></td>
					</tr>
					<tr>
						<td><label><span style='margin-top: 15px'>CJ fillet:</span></label></td>
						<td><input type='checkbox' name='CJfillet' id='CJfillet'
							value='Yes'></td>
					</tr>
					<tr>
						<td><label><span style='margin-top: 15px'>Foam filler to CJ:</span></label></td>
						<td><input type='checkbox' name='FoamfillertoCJ'
							id='FoamfillertoCJ' value='Yes'></td>
					</tr>
					<tr>
						<td colspan="2"><hr /></td>
					</tr>
				...
				<table style="border: 0px">
					<tr>
						<td><label style="margin-bottom: 0px"><span
								style="margin-bottom: 0px"><b>Pre-Construction</b></span></label></td>
						<td><label style="margin-bottom: 0px"><span
								style="margin-bottom: 0px"><b>Drawing No.</b></span></label></td>
					</tr>
					<tr>
						<td><label style="margin-bottom: 0px"><span
								style="margin-bottom: 0px">Architects GA/RCP</span></label></td>
						<td><label style="margin-top: 5px; margin-bottom: 0px"><span
								style="margin-top: 5px; margin-bottom: 0px"><input
									id="temperature" type="text" name="architectsGARCP"
									style="width: 150px" /></span></label></td>
					</tr>
					<tr>
						<td><label style="margin-bottom: 0px"><span
								style="margin-bottom: 0px">Architect's CS/WS</span></label></td>
						<td><label style="margin-top: 5px; margin-bottom: 0px"><span
								style="margin-top: 5px; margin-bottom: 0px"><input
									id="temperature" type="text" name="architectsCSWS"
									style="width: 150px" /></span></label></td>
					</tr>
					<tr>
						<td><label style="margin-bottom: 0px"><span
								style="margin-bottom: 0px">Structural Outline</span></label></td>
						<td><label style="margin-top: 5px; margin-bottom: 0px"><span
								style="margin-top: 5px; margin-bottom: 0px"><input
									id="structuralOutline" type="text" name="architectsCSWS"
									style="width: 150px" /></span></label></td>
					</tr>
					<tr>
						<td><label style="margin-bottom: 0px"><span
								style="margin-bottom: 0px">Formwork Certificate</span></label></td>
						<td><label style="margin-top: 5px; margin-bottom: 0px"><span
								style="margin-top: 5px; margin-bottom: 0px"><input
									id="formworkCertificate" type="text" name="architectsCSWS"
									style="width: 150px" /></span></label></td>
					</tr>
				</table>
				</p>
			...
			<div id="vertical-form" style="display: none">
				<h1>
					<table style="border: 0px">
						<tr>
							<td style="vertical-align: top"><img src="img/dinamo_small.png" /></td>
							<td><h1>
									Quality Assurance<br />Verticals
								</h1></td>
						</tr>
					</table>
				</h1>
				...
				<table style="border: 0px">
					<tr>
						...
						<td><label><input id="location" type="text" name="location"
								placeholder="Enter Location" style="width: 250px" /></label></td>
					</tr>
					<tr>
						<td colspan="2"><hr /></td>
					</tr>
					...
					<tr>
						...
						<td><input type='checkbox' name='Nailheightssprayed'
							id='Nailheightssprayed' value='Yes'></td>
					</tr>
					<tr>
						<td><label><span style='margin-top: 15px'>Penetrations for
									services:</span></label></td>
					...
					<tr>
						...
						<td><input type='checkbox' name='Postpourplumb' id='Postpourplumb'
							value='Yes'></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type='checkbox' name='She-Boltstiedoff'
							id='She-Boltstiedoff' value='Yes'></td>
					</tr>
					<tr>
						<td><label><span style='margin-top: 15px'>Working platform:</span></label></td>
						<td><input type='checkbox' name='Workingplatform'
							id='Workingplatform' value='Yes'></td>
					</tr>
					<tr>
						<td><label><span style='margin-top: 15px'>Access Ladder:</span></label></td>
						<td><input type='checkbox' name='AccessLadder' id='AccessLadder'
							value='Yes'></td>
					</tr>
					<tr>
						<td><label><span style='margin-top: 15px'>Foam filler required:</span></label></td>
						<td><input type='checkbox' name='Foamfillerrequired'
							id='Foamfillerrequired' value='Yes'></td>
					</tr>
					<tr>
						<td><label><span style='margin-top: 15px'>Z bars tied off:</span></label></td>
						<td><input type='checkbox' name='Zbarstiedoff' id='Zbarstiedoff'
							value='Yes'></td>
					</tr>
					<tr>
						<td><label><span style='margin-top: 15px'>Stop end nailed:</span></label></td>
						<td><input type='checkbox' name='Stopendnailed' id='Stopendnailed'
							value='Yes'></td>
					</tr>
					<tr>
						<td colspan="2"><hr /></td>
					...
					<tr>
						<td colspan="2"><textarea name="comments" rows=10
	...
	<div>
		...
		<div class="basic-grey"
			style="background: white; padding: 0px; border: 0px">
			<label><input type="button" class="button" value="Submit Details"
